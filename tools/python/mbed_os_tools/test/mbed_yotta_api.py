...
from .mbed_target_info import get_mbed_target_from_current_dir, get_binary_type_for_platform
...
def get_test_spec_from_yt_module(opts):
    ...
    if opts.list_of_targets:
        ...
        if current_target:
            ...
            gt_logger.gt_log_err(
                ...
                % (gt_logger.gt_bright("mbedgt -t <yotta_target>"), gt_logger.gt_bright("yotta target <yotta_target>"))
            )
    ...
    for yt_target in yt_targets:
        ...
        # Find tests
        ctest_test_list = load_ctest_testsuite(base_path, binary_type=get_binary_type_for_platform(platform))
