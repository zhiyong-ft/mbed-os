...
class BasicTestCase(unittest.TestCase):
    ...
    def test_list_mbeds_valid_platform(self):
        ...
        with patch("mbed_lstools.lstools_base.MbedLsToolsBase._read_htm_ids") as _read_htm, patch(
            "mbed_lstools.lstools_base.MbedLsToolsBase.mount_point_ready"
        ) as _mpr, patch("mbed_os_tools.detect.platform_database.PlatformDatabase.get") as _get, patch(
    ...
    def test_list_mbeds_unmount_mid_read(self):
        ...
        with patch("mbed_lstools.lstools_base.MbedLsToolsBase.mount_point_ready") as _mpr, patch(
            "mbed_os_tools.detect.lstools_base.listdir"
        ) as _listdir:
            _mpr.return_value = True
...
"""
    ...
    def test_list_mbeds_read_details_txt_failure(self):
        def _test(mock):
            ...
            with patch("mbed_lstools.lstools_base.MbedLsToolsBase.mount_point_ready") as _mpr, patch(
                "mbed_os_tools.detect.lstools_base.listdir"
            ) as _listdir, patch("mbed_lstools.lstools_base.MbedLsToolsBase._update_device_from_htm") as _htm, patch(
                "mbed_os_tools.detect.lstools_base.open", mock, create=True
            ):
                _mpr.return_value = True
    ...
    def test_device_type_unmounted(self):
        ...
        with patch("mbed_os_tools.detect.platform_database.PlatformDatabase.get") as _get, patch(
            "mbed_os_tools.detect.lstools_base.listdir"
        ) as _listdir:
            _get.return_value = {"platform_name": "foo_target"}
            to_check = self.base.list_mbeds()
    ...
    def test_fs_never(self):
        ...
        with patch("mbed_lstools.lstools_base.MbedLsToolsBase._update_device_from_fs") as _up_fs, patch(
            "mbed_lstools.lstools_base.MbedLsToolsBase.mount_point_ready"
...
class RetargetTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with patch("os.path.isfile") as _isfile, patch("mbed_os_tools.detect.lstools_base.isfile") as _isfile, patch(
