...
class ParseMbedHTMTestCase(unittest.TestCase):
    ...
    # DAPlink <0240
    test_mbed_htm_k64f_url_str = (
        '<meta http-equiv="refresh" content="0; url=http://mbed.org/device/?code=02400203D94B0E7724B7F3CF"/>'
    )
    test_mbed_htm_l152re_url_str = (
        '<meta http-equiv="refresh" content="0; url=http://mbed.org/device/?code=07100200656A9A955A0F0CB8"/>'
    )
    ...
    test_mbed_htm_nucleo_l031k6_str = (
        '<meta http-equiv="refresh" content="0; url=http://mbed.org/device/?code=07900221461663077952F5AA"/>'
    )
