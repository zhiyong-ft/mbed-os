...
class PlatformDetectionTestCase(unittest.TestCase):
    ...
    def run_test(self, test_data_case, candidate_data, expected_data):
        ...
        self.assertTrue(
            test_data_case in test_data_cases,
            "Expected %s to be present in %s folder" % (test_data_case, test_data_path),
        )
        ...
        mocked_open_file_paths = [
            os.path.join(candidate_data["mount_point"], file_name) for file_name in test_data_case_file_names
        ]
        ...
        with patch("mbed_os_tools.detect.lstools_base.MbedLsToolsBase.mount_point_ready") as _mpr, patch(
            "mbed_os_tools.detect.lstools_base.open", do_open
        ) as _, patch("mbed_os_tools.detect.lstools_base.listdir") as _listdir:
    ...
    def test_efm32pg_stk3401_jlink(self):
        self.run_test(
            "efm32pg_stk3401_jlink",
            {"target_id_usb_id": "000440074453", "vendor_id": "1366", "product_id": "1015"},
            {
    ...
    def test_lpc1768(self):
        self.run_test(
            "lpc1768",
            {"target_id_usb_id": "101000000000000000000002F7F20DF3", "vendor_id": "0d28", "product_id": "0204"},
            {
    ...
    def test_nucleo_f411re_stlink(self):
        self.run_test(
            "nucleo_f411re_stlink",
            {"target_id_usb_id": "0671FF554856805087112815", "vendor_id": "0483", "product_id": "374b"},
            {
    ...
    def test_nrf52_dk_jlink(self):
        self.run_test(
            "nrf52_dk_jlink",
            {"target_id_usb_id": "000682546728", "vendor_id": "1366", "product_id": "1015"},
            {
                "platform_name": "NRF52_DK",
                "device_type": "jlink",
