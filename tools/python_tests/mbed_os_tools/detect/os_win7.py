...
class Win7TestCase(unittest.TestCase):
    ...
    def test_is_mbed_volume(self):
        self.assertTrue(
            _is_mbed_volume(
                "_??_USBSTOR#Disk&Ven_MBED&Prod_VFS&Rev_0.1#0240000032044e4500367009997b00086781000097969900&0#{53f56307-b6bf-11d0-94f2-00a0c91efb8b}"
            )
        )
        self.assertTrue(
            _is_mbed_volume(
        ...
        self.assertFalse(
            _is_mbed_volume(
                "_??_USBSTOR#Disk&Ven_Invalid&Prod_VFS&Rev_0.1#0240000032044e4500367009997b00086781000097969900&0#{53f56307-b6bf-11d0-94f2-00a0c91efb8b}"
            )
        )
        self.assertFalse(
            _is_mbed_volume(
    ...
    def test_get_cached_mount_points(self):
        dummy_val = "dummy_val"
        volume_string_1 = "_??_USBSTOR#Disk&Ven_MBED&Prod_VFS&Rev_0.1#0240000032044e4500367009997b00086781000097969900&0#{53f56307-b6bf-11d0-94f2-00a0c91efb8b}"
        volume_string_2 = "_??_USBSTOR#Disk&Ven_MBED&Prod_VFS&Rev_0.1#1234000032044e4500367009997b00086781000097969900&0#{53f56307-b6bf-11d0-94f2-00a0c91efb8b}"
        with patch("mbed_os_tools.detect.windows._iter_vals") as _iter_vals, patch(
            ...
            _winreg.OpenKey.assert_called_once_with(_winreg.HKEY_LOCAL_MACHINE, "SYSTEM\\MountedDevices")
            _iter_vals.assert_called_once_with(dummy_val)
            _is_mbed_volume.assert_has_calls([call(volume_string_1), call(volume_string_2)])
            self.assertEqual(result, [{"mount_point": "D:", "volume_string": volume_string_1}])
    ...
    def test_get_disks(self):
        ...
        with patch("mbed_os_tools.detect.windows._get_values_with_numeric_keys") as _num_keys, patch(
            ...
            _winreg.OpenKey.assert_called_once_with(
                _winreg.HKEY_LOCAL_MACHINE, "SYSTEM\\CurrentControlSet\\Services\\Disk\\Enum"
            )
    ...
    def test_get_usb_storage_devices(self):
        ...
        with patch("mbed_os_tools.detect.windows._get_values_with_numeric_keys") as _num_keys, patch(
            ...
            _winreg.OpenKey.assert_called_once_with(
                _winreg.HKEY_LOCAL_MACHINE, "SYSTEM\\CurrentControlSet\\Services\\USBSTOR\\Enum"
            )
            _num_keys.assert_called_once_with(dummy_key)
            self.assertEqual(result, volume_strings)
    ...
    def test_determine_valid_non_composite_devices(self):
        ...
        with patch("mbed_os_tools.detect.windows._determine_subdevice_capability") as _capability:
            ...
            _winreg.OpenKey.assert_called_once_with(_winreg.HKEY_LOCAL_MACHINE, device_key_string)
            _capability.assert_called_once_with(dummy_key)
            self.assertEqual(
                result, {dummy_target_id: {"target_id_usb_id": dummy_target_id, "mount_point": dummy_mount_point}}
            )
    ...
    def test_one_composite_dev(self):
        value_dict = {
            (None, "SYSTEM\\MountedDevices"): [
                ("\\DosDevices\\C:", "NOT A VALID MBED DRIVE".encode("utf-16le")),
                (
                    "\\DosDevices\\F:",
                    "_??_USBSTOR#Disk&Ven_MBED&Prod_VFS&Rev_0.1#9&215b8c47&0&0240000032044e4500257009997b00386781000097969900&0#{53f56307-b6bf-11d0-94f2-00a0c91efb8b}".encode(
                        "utf-16le"
            ...
            (
                ((None, "SYSTEM\\CurrentControlSet\\Enum\\USB\\VID_0D28&PID_0204&MI_00"), "8&26b12a60&0&0000"),
                "CompatibleIDs",
            ): (["USB\\Class_08&SubClass_06&Prot_50", "USB\\Class_08&SubClass_06", "USB\\Class_08"], 7),
            (
                ((None, "SYSTEM\\CurrentControlSet\\Enum\\USB\\VID_0D28&PID_0204&MI_01"), "8&26b12a60&0&0001"),
                "CompatibleIDs",
            ): (["USB\\CLASS_02&SUBCLASS_02&PROT_01", "USB\\CLASS_02&SUBCLASS_02", "USB\\CLASS_02"], 7),
            (
                (
                    ((None, "SYSTEM\\CurrentControlSet\\Enum\\USB\\VID_0D28&PID_0204&MI_01"), "8&26b12a60&0&0001"),
                    "Device Parameters",
    ...
    def test_one_non_composite_dev(self):
        value_dict = {
            (None, "SYSTEM\\MountedDevices"): [
                ...
                (
                    "\\DosDevices\\F:",
                    "_??_USBSTOR#Disk&Ven_MBED&Prod_VFS&Rev_0.1#0000000032044e4500257009997b00386781000097969900&0#{53f56307-b6bf-11d0-94f2-00a0c91efb8b}".encode(
                        "utf-16le"
                    ),
                ),
            ],
        ...
        with patch("mbed_os_tools.detect.windows.MbedLsToolsWin7._run_cli_process") as _cliproc:
            ...
            expected_info = {
                "mount_point": "F:",
                "serial_port": None,
                "target_id_usb_id": "0000000032044e4500257009997b00386781000097969900",
                "vendor_id": "0d28",
                "product_id": "0204",
            }
