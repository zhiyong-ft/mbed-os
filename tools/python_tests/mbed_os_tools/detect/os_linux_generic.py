...
class LinuxPortTestCase(unittest.TestCase):
    ...
    def find_candidates_with_patch(self, mount_list, link_dict, listdir_dict, open_dict):
        ...
        with patch("mbed_os_tools.detect.linux.MbedLsToolsLinuxGeneric._run_cli_process") as _cliproc, patch(
            "os.readlink"
        ) as _readlink, patch("os.listdir") as _listdir, patch("os.path.abspath") as _abspath, patch(
            "mbed_os_tools.detect.linux.open", do_open
        ) as _, patch("os.path.isdir") as _isdir:
            ...
            def do_abspath(dir):
                _, path = os.path.splitdrive(os.path.normpath(os.path.join(os.getcwd(), dir)))
                path = path.replace("\\", "/")
                return path
    ...
    listdir_dict_rpi = {
        ...
        "/sys/class/block": ["sdb", "sdc", "sdd", "sde", "sdf", "sdg", "sdh"],
        "/sys/class/block/../../devices/pci0000:00/0000:00:06.0/usb1/1-1/1-1.2/1-1.2.6": ["idVendor", "idProduct"],
        "/sys/class/block/../../devices/pci0000:00/0000:00:06.0/usb1/1-3": ["idVendor", "idProduct"],
        "/sys/class/block/../../devices/pci0000:00/0000:00:06.0/usb1/1-4": ["idVendor", "idProduct"],
        "/sys/class/block/../../devices/pci0000:00/0000:00:06.0/usb1/1-5": ["idVendor", "idProduct"],
        "/sys/class/block/../../devices/pci0000:00/0000:00:06.0/usb1/1-6": ["idVendor", "idProduct"],
        "/sys/class/block/../../devices/pci0000:00/0000:00:06.0/usb1/1-7": ["idVendor", "idProduct"],
        "/sys/class/block/../../devices/pci0000:00/0000:00:06.0/usb1/1-8": ["idVendor", "idProduct"],
    }
    ...
    listdir_dict_1 = {
        ...
        "/sys/class/block": ["sdb", "sdc"],
        "/sys/class/block/../../devices/pci0000:00/0000:00:06.0/usb1/1-2": ["idVendor", "idProduct"],
        "/sys/class/block/../../devices/pci0000:00/0000:00:06.0/usb1/1-3": ["idVendor", "idProduct"],
    }
    ...
    listdir_dict_2 = {
        ...
        "/sys/class/block": ["sdb", "sdc", "sdd", "sde", "sdf"],
        "/sys/class/block/../../devices/pci0000:00/0000:00:06.0/usb1/1-2": ["idVendor", "idProduct"],
        "/sys/class/block/../../devices/pci0000:00/0000:00:06.0/usb1/1-3": ["idVendor", "idProduct"],
        "/sys/class/block/../../devices/pci0000:00/0000:00:06.0/usb1/1-4": ["idVendor", "idProduct"],
        "/sys/class/block/../../devices/pci0000:00/0000:00:06.0/usb1/1-5": ["idVendor", "idProduct"],
    ...
    listdir_dict_4 = {
        ...
        "/dev/serial/by-id": ["pci-ARM_DAPLink_CMSIS-DAP_0240000033514e45001f500585d40014e981000097969900-if01"],
        "/sys/class/block": ["sdb"],
        "/sys/class/block/../../devices/pci0000:00/0000:00:06.0/usb1/1-2": ["idVendor", "idProduct"],
    }
