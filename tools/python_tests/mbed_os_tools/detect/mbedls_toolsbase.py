...
class BasicTestCase(unittest.TestCase):
    ...
    def test_list_mbeds_valid_platform(self):
        self.base.return_value = [
            ...
            {"mount_point": None, "target_id_usb_id": "00000000000", "serial_port": "not_valid"},
        ]
        with patch("mbed_os_tools.detect.lstools_base.MbedLsToolsBase._read_htm_ids") as _read_htm, patch(
            "mbed_os_tools.detect.lstools_base.MbedLsToolsBase.mount_point_ready"
        ) as _mpr, patch("mbed_os_tools.detect.lstools_base.PlatformDatabase.get") as _get, patch(
            "mbed_os_tools.detect.lstools_base.listdir"
        ) as _listdir:
    ...
    def test_list_mbeds_invalid_tid(self):
        self.base.return_value = [
            ...
            {"mount_point": "dummy_mount_point", "target_id_usb_id": "", "serial_port": "not_valid"},
        ]
        with patch("mbed_os_tools.detect.lstools_base.MbedLsToolsBase._read_htm_ids") as _read_htm, patch(
            "mbed_os_tools.detect.lstools_base.MbedLsToolsBase.mount_point_ready"
        ) as _mpr, patch("mbed_os_tools.detect.lstools_base.PlatformDatabase.get") as _get, patch(
            ...
            _mpr.return_value = True
            _read_htm.side_effect = [("0241BEEFDEAD", {}), (None, {})]
            _get.return_value = {"platform_name": "foo_target"}
            _listdir.return_value = ["mbed.htm"]
            to_check = self.base.list_mbeds()
            _get.assert_any_call("0241", device_type="daplink", verbose_data=True)
    ...
    def test_list_mbeds_invalid_platform(self):
        self.base.return_value = [
            {
                "mount_point": "dummy_mount_point",
                "target_id_usb_id": "not_in_target_db",
                "serial_port": "dummy_serial_port",
            }
        ]
        for qos in [FSInteraction.BeforeFilter, FSInteraction.AfterFilter]:
            with patch("mbed_os_tools.detect.lstools_base.MbedLsToolsBase._read_htm_ids") as _read_htm, patch(
                ...
                _mpr.return_value = True
                _read_htm.return_value = ("not_in_target_db", {})
    ...
    def test_list_mbeds_unmount_mid_read(self):
        ...
        with patch("mbed_os_tools.detect.lstools_base.MbedLsToolsBase.mount_point_ready") as _mpr, patch(
            "mbed_os_tools.detect.lstools_base.listdir"
        ) as _listdir:
            _mpr.return_value = True
    ...
    def test_list_mbeds_read_mbed_htm_failure(self):
        def _test(mock):
            ...
            with patch("mbed_os_tools.detect.lstools_base.MbedLsToolsBase.mount_point_ready") as _mpr, patch(
                "mbed_os_tools.detect.lstools_base.listdir"
            ) as _listdir, patch("mbed_os_tools.detect.lstools_base.open", mock, create=True):
                _mpr.return_value = True
...
"""
        ...
        with patch("mbed_os_tools.detect.lstools_base.MbedLsToolsBase.mount_point_ready") as _mpr, patch(
            "mbed_os_tools.detect.lstools_base.listdir"
        ) as _listdir, patch("mbed_os_tools.detect.lstools_base.open", m, create=True) as mocked_open:
    ...
    def test_list_mbeds_read_details_txt_failure(self):
        def _test(mock):
            ...
            with patch("mbed_os_tools.detect.lstools_base.MbedLsToolsBase.mount_point_ready") as _mpr, patch(
                ...
                "mbed_os_tools.detect.lstools_base.MbedLsToolsBase._update_device_from_htm"
            ) as _htm, patch("mbed_os_tools.detect.lstools_base.open", mock, create=True):
                _mpr.return_value = True
    ...
    def test_detect_device_test(self):
        device_type = self.base._detect_device_type({"vendor_id": "0483"})
        self.assertEqual(device_type, "stlink")

        device_type = self.base._detect_device_type({"vendor_id": "0d28"})
        self.assertEqual(device_type, "daplink")

        device_type = self.base._detect_device_type({"vendor_id": "1366"})
    ...
    def test_device_type_unmounted(self):
        ...
        with patch("mbed_os_tools.detect.lstools_base.PlatformDatabase.get") as _get, patch(
            "mbed_os_tools.detect.lstools_base.listdir"
        ) as _listdir:
            _get.return_value = {"platform_name": "foo_target"}
            to_check = self.base.list_mbeds()
    ...
    def test_fs_never(self):
        ...
        with patch("mbed_os_tools.detect.lstools_base.MbedLsToolsBase._update_device_from_fs") as _up_fs, patch(
            "mbed_os_tools.detect.lstools_base.MbedLsToolsBase.mount_point_ready"
    ...
    def test_fs_after(self):
        ...
        with patch("mbed_os_tools.detect.lstools_base.MbedLsToolsBase._read_htm_ids") as _read_htm, patch(
            "mbed_os_tools.detect.lstools_base.MbedLsToolsBase._details_txt"
        ) as _up_details, patch(
            "mbed_os_tools.detect.lstools_base.MbedLsToolsBase.mount_point_ready"
        ) as mount_point_ready, patch("mbed_os_tools.detect.lstools_base.listdir") as _listdir:
            ...
            self.base.return_value = [deepcopy(device)]
            ret = self.base.list_mbeds(FSInteraction.AfterFilter, filter_in, False, False)
            self.base.return_value = [deepcopy(device)]
            ret_with_details = self.base.list_mbeds(FSInteraction.AfterFilter, filter_details, False, True)
            ...
            self.base.return_value = [deepcopy(device)]
            ret = self.base.list_mbeds(FSInteraction.AfterFilter, filter_out, False, False)
            self.base.return_value = [deepcopy(device)]
            ret_with_details = self.base.list_mbeds(FSInteraction.AfterFilter, filter_out, False, True)
    ...
    def test_fs_before(self):
        ...
        with patch("mbed_os_tools.detect.lstools_base.MbedLsToolsBase._read_htm_ids") as _read_htm, patch(
            ...
            self.base.return_value = [deepcopy(device)]
            ret_with_details = self.base.list_mbeds(FSInteraction.BeforeFilter, filter, False, True)
            self.assertIsNotNone(ret[0])
            self.assertIsNotNone(ret_with_details[0])
            self.assertEqual(ret[0]["target_id"], new_device_id)
            self.assertEqual(ret_with_details[0]["daplink_automation_allowed"], "0")
            ...
            self.base.return_value = [deepcopy(device)]
            ret = self.base.list_mbeds(FSInteraction.BeforeFilter, filter_in, False, False)
            _up_details.assert_not_called()

            self.base.return_value = [deepcopy(device)]
            ret_with_details = self.base.list_mbeds(FSInteraction.BeforeFilter, filter_in_details, False, True)
            ...
            ret = self.base.list_mbeds(FSInteraction.BeforeFilter, filter_out, False, False)
            _up_details.assert_not_called()

            self.base.return_value = [deepcopy(device)]
            ret_with_details = self.base.list_mbeds(FSInteraction.BeforeFilter, filter_out_details, False, True)
...
class RetargetTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with patch("mbed_os_tools.detect.lstools_base.isfile") as _isfile, patch(
            "mbed_os_tools.detect.lstools_base.open", _open, create=True
        ):
    ...
    def test_list_mbeds_valid_platform(self):
        ...
        with patch("mbed_os_tools.detect.lstools_base.MbedLsToolsBase._read_htm_ids") as _read_htm, patch(
            ...
            _mpr.return_value = True
            _read_htm.return_value = ("0240DEADBEEF", {})
            _get.return_value = {"platform_name": "foo_target"}
            _listdir.return_value = ["mbed.htm"]
            to_check = self.base.list_mbeds()
        self.assertEqual(len(to_check), 1)
